    ...
    const handleDeleteBudget = async (id: number): Promise<void> => {
        ...
        if (result.isConfirmed) {
            try {
                ...
                await fetchApiFindAllPaginationBudget();
            }
        }
    };
                    ...
                    {isLoading ? (
                        ...
                        budgets?.content.map((budget, index) => (
                            <tr key={budget.id} className="border-b text-center">
                                ...
                                <td scope="row" className="px-2.5 py-2 break-words text-right whitespace-nowrap text-red-700">
                                ...
                                <td scope="row" className="px-2.5 py-2 whitespace-nowrap">
                                    <CustomDropdown>
                                        <>
                                            <DropdownEdit onClick={() => handleEditBudget(budget.id)} />
